...
export const heroData: HeroProps = {
  title: (
    <>
      ...
      <span className="sm:whitespace-nowrap">Grafiki filologa</span>
    </>
  ),
  subtitle: (
    <>
      <span className="hidden md:inline">
        ...
        to dynamiczna strona internetowa, która koncentruje się na przygotowaniu 
      do matury z lektur z języka polskiego oraz na zapewnieniu podstawowych informacji dotyczących 
      języka rosyjskiego i hiszpańskiego.
        {/* </span> */}
      </span>
    </>
  ),
...
export const socialProofData: SocialProofProps = {
  images: [
    {
      link: 'https://www.instagram.com/grafiki_filologa/',
      src: instagramLogo,
      alt: 'Instagram Logo',
    },
    {
      link: 'https://www.tiktok.com/@grafiki_filologa',
      src: tiktokLogo,
      alt: 'Tiktok Logo',
    },
    // {
...
export const footerData: FooterProps = {
  ...
  socials: [
    { label: 'Instagram', icon: IconBrandInstagram, href: 'https://www.instagram.com/grafiki_filologa/' },
    { label: 'TikTok', icon: IconBrandTiktok, href: 'https://www.tiktok.com/@grafiki_filologa' },
